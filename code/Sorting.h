...
// function returns, merged content will be in that vector (hence pass by
// reference).
...
// Utility function to output the contents of a vector<int> for debugging.
// To use this, simply run disp(your_vector).
